...
export const Route = createFileRoute("/video/$videoId_/edit")({
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground text-sm">
              ...
              {surveyQuestions.length} survey question{surveyQuestions.length !== 1 ? "s" : ""}
            </p>
          </div>
          <div className="flex gap-2">
            <Button variant="outline" onClick={() => window.location.href = `/video/${videoId}`}>
              View Mode
            </Button>
